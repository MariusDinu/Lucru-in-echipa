                ...
                try {
                    ...
                    if (received.equals("Join")) {
                        ...
                        if (game.b.countplayers == game.b.players) {  /*Daca numarul de playeri e ok dam drumul la joc*/
                          ...
                          this.dos.writeUTF("Jocul a inceput"); dos.flush();  /*trimitem un mesaj cum ca jocul a inceput*/
                            /*
                            this.dos.writeUTF("a");*/

                        } else System.out.println("Mai asteptam playeri");  /*sau afisam ca nu sunt destui playeri in camera*/
                    }
